export default function MetricCard({ header, link, metric, isCurrency }) {
  return (
    <div className="metric-card bg-gray-100 dark:bg-gray-900 border border-gray-500 dark:border-gray-500 rounded-lg p-4 max-w-72 w-full opacity-[.75] hover:opacity-100">
      <a
        aria-label={header}
        target="_blank"
