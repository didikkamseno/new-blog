...
function Nav({
  ...
  return (
    <div
      ...
      } nav sm:hidden justify-between overflow-x-hidden space-x-0 shadow-2xl z-10 fixed bottom-0 top-0 flex flex-col pt-20 sm:pt-10 px-5 dark:bg-neutral-900 dark:border-r-[1px] dark:border-neutral-800 bg-white bg-opacity-60 sm:bg-opacity-20 dark:bg-opacity-100 drop-shadow-lg backdrop-blur-lg w-56 h-full overflow-scroll`}
    >
