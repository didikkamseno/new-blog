...
export default function NavItems() {
  ...
  return (
    ...
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	  viewBox="0 0 231.104 231.104" className="enable-background:new 0 0 231.104 231.104;">
    <g>
	  <path fill="currentColor" clipRule="evenOdd" d="M4.453,173.33c9.763-1.192,19.663,0.092,29.426-1.512c4.904-0.779,9.396-2.429,13.842-4.171
