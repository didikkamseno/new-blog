...
We will create two components `components/ProsCard.tsx` and `components/ConsCard.tsx`, then pass these cards through`components/MDXComponents.tsx`.
...
Now, finally the components

```tsx:components/ProsCard.tsx
