...
- [Attendance Certificate](https://v1.heykapil.in/static/docs/New_Attendance_Certificate_CSIR.docx) _to be furnished on letter head of department/university_ and [Attendance Record](/static/docs/ATTENDANCE_RECORD.docx)
