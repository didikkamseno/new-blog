      ...
      <Container>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          ...
          <span className="group relative top-[6px]  inline-block cursor-text overflow-hidden">
            <span className="invisible">junior research fellow</span>
            <span
          ...
          <span
            className={classNames(
              ...
              "relative after:absolute after:-bottom-1 after:left-0 after:h-[2px] after:w-[235px]",
        ...
        <p className="mt-2 mb-2 text-gray-600 dark:text-gray-400">
          Being funded by{" "}
          <a
            className={classNames(
          ...
          >
            CSIR-HRDG, India.
              ...
              <div className="mb-8 text-gray-600 dark:text-gray-400 hidden sm:flex">
               <TypedBios />
              </div>
